...
O conteúdo deste documento foi reorganizado em subpastas por papel. Consulte:

- **[Contexto compartilhado](cenario-3-contexto.md)** — informações gerais do cenário
- **[Índice de exercícios](cenario-3-indice.md)** — links para todos os exercícios

Cada exercício tem sua própria pasta:
- `exercicio-3-X-delivery-manager/`
- `exercicio-3-X-product-specialist/`
- `exercicio-3-X-desenvolvedor/`
- `exercicio-3-X-tech-lead/`
- `exercicio-3-X-qa/`
